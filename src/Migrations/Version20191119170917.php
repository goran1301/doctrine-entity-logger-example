 ...
 */
final class Version20191119170917 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE log (id INT NOT NULL, message TEXT NOT NULL, loggedat TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
